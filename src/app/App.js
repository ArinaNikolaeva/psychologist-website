...
const heroData = {
    ...
    description: 'Помогаю парам и индивидуально выстраивать здоровые отношения, понимать свои чувства, находить баланс и доверие.',
...
const aboutData = {
    name: 'Арина Николаева',
    experience: 'Практикующий психолог · Молодой специалист',
    intro: 'Мне 22 года, я закончила ИРНИТУ (политех). Моя специализация — отношения: с партнёром, с собой, с близкими.',
    description: 'В работе использую гештальт-подход и элементы системной терапии. Важно не только понять, что происходит, но и почувствовать — где ваша правда, где ваши границы.',
    image: 'images/about-photo.jpg',
    meta: ['🎓 ИРНИТУ (политех)', '📚 Гештальт-терапия', '💬 Отношения · Кризисы · Самооценка']
};
